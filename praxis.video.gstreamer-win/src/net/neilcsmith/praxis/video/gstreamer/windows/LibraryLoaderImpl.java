...
class LibraryLoaderImpl {
    ...
    void load() throws Exception {
        ...
        File dir;
        if (Platform.is64Bit()) {
            dir = InstalledFileLocator.getDefault().locate("modules/lib/windows64",
                    "net.neilcsmith.praxis.video.gstreamer.windows", false);
        } else {
            dir = InstalledFileLocator.getDefault().locate("modules/lib/windows32",
                    "net.neilcsmith.praxis.video.gstreamer.windows", false);
        }
