 ...
 */
public class SetCommand extends AbstractInlineCommand {

    private final static Logger log = Logger.getLogger(SetCommand.class.getName());
    ...
    private class VarImpl implements Variable {
