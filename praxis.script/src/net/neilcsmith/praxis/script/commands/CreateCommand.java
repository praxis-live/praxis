...
public class CreateCommand implements Command {
    ...
    private final static ControlAddress createAddress = ControlAddress.create("/praxis.create");
    ...
    private class CreateStackFrame implements StackFrame {
        ...
        public StackFrame process(Context context) {
            if (state == State.Incomplete && call == null) {
                call = Call.createCall(createAddress, context.getAddress(), context.getTime(), args);
