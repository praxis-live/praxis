...
import net.neilcsmith.ripl.render.opengl.GLPlayer;

/**
 *
 * @author nsigma
 */
public class GLFactoryProvider implements PlayerFactory.Provider {
    ...
    private static class Factory implements PlayerFactory {
        ...
        public Player createPlayer(PlayerConfiguration config, ClientConfiguration[] clients)
            ...
            return GLPlayer.create("OPENGL TEST", config.getWidth(), config.getHeight(), config.getFPS(), false);
