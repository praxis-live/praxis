 ...
 * Practicamente todo el esfuerzo se centra en pintar la pestaa.
...
public class NimRODTabbedPaneUI extends BasicTabbedPaneUI {
  ...
  protected void paintTabBackground( Graphics g, int tabPlacement,
   ...
   /**
    * Este metodo devuelve un tamao mas grande de lo necesario, haciendoer hueco para
    * la decoracion.
    */
  protected int calculateTabWidth( int tabPlacement, int tabIndex, FontMetrics metrics) {
   ...
   /**
    * Este metodo devuelve un tamao mas grande de lo necesario, haciendo el hueco para
    * la decoracion.
    */
