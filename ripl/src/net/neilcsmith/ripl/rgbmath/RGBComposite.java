...
public abstract class RGBComposite {
    ...
    public abstract void composeRGB(int[] src, int srcPos,
            int[] destIn, int destInPos,
            int[] destOut, int destOutPos,
            int length);
    ...
    public static class AddPin extends RGBComposite {

        public AddPin(double extraAlpha) {
            super(extraAlpha);
        }
...
//            int srcPx, b;
            ...
            for (int i = 0; i < length; i++) {
                ...
                destOut[destOutPos] = min(srcR + destR, 0xFF) << 16 |
...
//                        min(srcB + destB, 0xFF);
    ...
    public static class Blend extends RGBComposite {

        public Blend(double extraAlpha) {
            super(extraAlpha);
        }
        ...
        public void composeRGB(int[] src, int srcPos, int[] destIn, int destInPos, int[] destOut, int destOutPos, int length) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                destOut[destOutPos] = blend(srcR, destR, alpha) << 16 |
    ...
    public static class SubPin extends RGBComposite {

        public SubPin(double extraAlpha) {
            super(extraAlpha);
        }
        ...
        public void composeRGB(int[] src, int srcPos, int[] destIn, int destInPos, int[] destOut, int destOutPos, int length) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                destOut[destOutPos] = max(destR - srcR, 0) << 16 |
                        max(destG - srcG, 0) << 8 |
                        max(destB - srcB, 0);
    ...
    public static class Difference extends RGBComposite {
        ...
        public void composeRGB(int[] src, int srcPos, int[] destIn, int destInPos, int[] destOut, int destOutPos, int length) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                destOut[destOutPos] = alpha == 255 ? diff(srcR, destR) << 16 |
                        diff(srcG, destG) << 8 |
    ...
    public static class BitXor extends RGBComposite {
        ...
        public void composeRGB(int[] src, int srcPos, int[] destIn, int destInPos, int[] destOut, int destOutPos, int length) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                destOut[destOutPos] = (srcR ^ destR) << 16 |
                        (srcG ^ destG) << 8 |
                        (srcB ^ destB);
    ...
    public static class Screen extends RGBComposite {
        ...
        public void composeRGB(int[] src, int srcPos, int[] destIn, int destInPos, int[] destOut, int destOutPos, int length) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                destOut[destOutPos] = (255 - mult(255 - srcR, 255 - destR)) << 16 |
    ...
    public static class Multiply extends RGBComposite {
        ...
        public void composeRGB(int[] src, int srcPos, int[] destIn, int destInPos, int[] destOut, int destOutPos, int length) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                destOut[destOutPos] = (alpha == 255) ? mult(srcR, destR) << 16 |
                        mult(srcG, destG) << 8 |
                        mult(srcB, destB)
