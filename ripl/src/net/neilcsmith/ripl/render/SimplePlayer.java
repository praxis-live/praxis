...
// * @author Neil C Smith
// */
//public class SimplePlayer implements FrameRateSource, Runnable {
//
//    private int noSleepsPerYield = 10; // maximum number of frames without sleep before yielding
...
//    private Surface surface = null; // surface to be passed up tree
...
//
//    public SimplePlayer(int width, int height, int fps) {
