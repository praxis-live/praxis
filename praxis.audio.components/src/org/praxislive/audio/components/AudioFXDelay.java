 ...
 */
@GenerateTemplate(AudioFXDelay.TEMPLATE_PATH)
public class AudioFXDelay extends AudioCodeDelegate {
    
    final static String TEMPLATE_PATH = "resources/fx_delay.pxj";
