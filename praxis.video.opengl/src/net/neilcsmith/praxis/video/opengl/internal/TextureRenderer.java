...
public class TextureRenderer implements Disposable {
    ...
    public TextureRenderer( int size) {
        this(size, 1);
    }
    ...
    public TextureRenderer(int size, int buffers) {
...
//            GL14.glBlendColor(blendColor.r, blendColor.g, blendColor.b, blendColor.a);
        }
    ...
    public void setBlendFunction(int srcFunc, int dstFunc) {
        setBlendFunction(srcFunc, dstFunc, srcFunc, dstFunc, Color.BLACK);
    }
    
    public void setBlendFunction(int srcRGBFunc, int dstRGBFunc, int srcAlphaFunc, int dstAlphaFunc) {
        setBlendFunction(srcRGBFunc, dstRGBFunc, srcAlphaFunc, dstAlphaFunc, Color.BLACK);
    }
    
    public void setBlendFunction(int srcRGBFunc, int dstRGBFunc, int srcAlphaFunc, int dstAlphaFunc, Color color) {
        renderMesh();
