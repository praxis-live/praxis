...
//import net.neilcsmith.ripl.render.opengl.internal.*;
//
//import net.neilcsmith.ripl.render.opengl.Color;
//import net.neilcsmith.ripl.render.opengl.Matrix4;
//import net.neilcsmith.ripl.render.opengl.Mesh;
//import net.neilcsmith.ripl.render.opengl.ShaderProgram;
//import net.neilcsmith.ripl.render.opengl.internal.VertexAttributes.Usage;
//import org.lwjgl.opengl.GL11;
//
///** <p>
// * A TextureRenderer is used to draw 2D rectangles that reference a texture (region). The class will batch the drawing commands and
// * optimize them for processing by the GPU.
// * </p>
// * 
// * <p>
// * To draw something with a TextureRenderer one has to first call the {@link TextureRenderer#begin()} method which will setup appropriate
// * render states. When you are done with drawing you have to call {@link TextureRenderer#end()} which will actually draw the things
// * you specified.
// * </p>
// * 
// * <p>
// * All drawing commands of the TextureRenderer operate in screen coordinates. The screen coordinate system has an x-axis pointing to
...
// * 
// * <p>
// * A TextureRenderer is managed. In case the OpenGL context is lost all OpenGL resources a TextureRenderer uses internally get
// * invalidated. A context is lost when a user switches to another application or receives an incoming call on Android. A
// * TextureRenderer will be automatically reloaded after the OpenGL context is restored.
// * </p>
// * 
// * <p>
// * A TextureRenderer is a pretty heavy object so you should only ever have one in your program.
// * </p>
// * 
// * <p>
// * A TextureRenderer works with OpenGL ES 1.x and 2.0. In the case of a 2.0 context it will use its own custom shader to draw all
// * provided sprites. You can set your own custom shader via {@link #setShader(ShaderProgram)}.
// * </p>
// * 
// * <p>
// * A TextureRenderer has to be disposed if it is no longer used.
// * </p>
// * 
// * @author mzechner */
//public class SurfaceRenderer implements Disposable {
//
...
//    private GLSurface src;
//    private GLSurface dst;
//
...
//    public SurfaceRenderer(int size) {
//        this(size, 1);
//    }
//
//    /** <p>
...
//    public SurfaceRenderer(int size, int buffers) {
...
//    }
//
//    /** Sets up the TextureRenderer for drawing. This will disable depth buffer writting. It enables blending and texturing. If you have
...
//    public void begin(int width, int height) throws GLException {
//        if (drawing) {
...
//     * {@link #begin()} */
//    public void end() throws GLException {
//        if (!drawing) {
...
//    public void draw(GLSurface surface, float x, float y) throws GLException {
//        draw(surface, x, y, surface.getWidth(), surface.getHeight());
//    }
//
//    /** Draws a rectangle with the bottom left corner at x,y and stretching the region to cover the given width and height. */
//    public void draw(GLSurface surface, float x, float y, float width, float height) throws GLException {
//        if (!drawing) {
//            throw new IllegalStateException("SpriteBatch.begin must be called before draw.");
//        }
//
...
//            src = surface;
//            surface.bindTexture();
//            invTexWidth = 1f / surface.getTextureWidth();
//            invTexHeight = 1f / surface.getTextureHeight();
//        } else if (idx == vertices.length) {
//            renderMesh();
//        }
//
...
//        final float fy2 = y + height;
//        final float u = 0;
//        final float v = surface.getHeight() * invTexHeight;
//        final float u2 = surface.getWidth() * invTexWidth;
//        final float v2 = 0;
//
//        vertices[idx++] = x;
//        vertices[idx++] = y;
...
////        vertices[idx++] = v4;
////    }
////    /** Causes any pending sprites to be rendered, without ending the TextureRenderer. */
////    public void flush() {
////        renderMesh();
////    }
//    private void renderMesh() throws GLException {
//        if (idx == 0) {
//            return;
//        }
//
...
//    public void disableBlending() throws GLException {
//        renderMesh();
//        blendingDisabled = true;
//    }
//
//    /** Enables blending for sprites */
//    public void enableBlending() throws GLException {
//        renderMesh();
...
//    public void setBlendFunction(int srcFunc, int dstFunc) throws GLException {
//        renderMesh();
...
//    }
//
//    /** Sets the projection matrix to be used by this TextureRenderer. If this is called inside a {@link #begin()}/{@link #end()} block.
...
////    }
////
////    /** Sets the transform matrix to be used by this TextureRenderer. If this is called inside a {@link #begin()}/{@link #end()} block.
////     * the current batch is flushed to the gpu.
////     * 
