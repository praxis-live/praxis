 ...
 */
public class CustomCodeProperty extends CodeProperty<CustomVideoDelegate> {
    ...
    @Override
    protected Task<CustomVideoDelegate> createTask(String code) {
        return new TaskImpl(code);
    }
    
    private class TaskImpl extends Task<CustomVideoDelegate> {
        ...
        @Override
        protected CodeContext<CustomVideoDelegate> createCodeContext(CustomVideoDelegate delegate) {
            return new CustomVideoContext(new CustomVideoConnector(delegate));
        }
