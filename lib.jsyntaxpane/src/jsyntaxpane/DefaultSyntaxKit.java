...
public class DefaultSyntaxKit extends DefaultEditorKit implements ViewFactory {
        ...
        public static final String CONFIG_BACKGROUND_COLOR = "Background.Color";
	public static final String CONFIG_CARETCOLOR = "Caret.Color";
	public static final String CONFIG_SELECTION = "Selection.Color";
...
//                    System.out.println("Removing popup");
	...
	public void install(JEditorPane editorPane) {
		...
		Configuration conf = getConfig();
                Color bgColor = conf.getColor(CONFIG_BACKGROUND_COLOR, Color.WHITE);
	...
	public synchronized static void initKit() {
		...
		if (defaultFont != null) {
			...
			if (Arrays.binarySearch(fonts, "Courier New") >= 0) {
				DEFAULT_FONT = new Font("Courier New", Font.PLAIN, 13);
			} else if (Arrays.binarySearch(fonts, "Courier") >= 0) {
				DEFAULT_FONT = new Font("Courier", Font.PLAIN, 13);
